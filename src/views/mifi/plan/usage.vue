          ...
          <ul v-show="usageListObj[index].length>0" class="plan-list-wrap">
            ...
            >
              ...
              <div v-if="index==0" class="priority-wrap">
                ...
                <button @click="usedPriority({iccid:iccid,source:source,id:inner_item.id,priority:inner_item.priority})"
                        v-if="inner_item.priority==0">取消优先
                </button>
              ...
              <div class="usage-data-inner-wrap">
                ...
                >
                  ...
                  <div class="data-wrap" v-if="inner_item.total_flow">
                    <p>已使用</p>
                    <p v-if="inner_item.total_flow>=0">{{changedUnit(inner_item.total_flow -
                      inner_item.remaining_flow,true)}}</p>
                  ...
                  <!--<div class="data-wrap">-->
                  <div class="data-wrap"
                       v-if="(inner_item.total_flow || inner_item.total_flow == 0) && !inner_item.total_voice && index!=3 ">
                    <p>套餐时长</p>
                ...
                <div class="usage-right">
                  ...
                  <div v-if="inner_item.total_flow >= 0">
                    <p class="usage-right-data" v-if="inner_item.total_flow >=1024">
                      {{toDecimal(inner_item.remaining_flow/1024)}}<span>/G</span></p>
...
<script>
  ...
  export default {
    ...
    methods: {
      initial() {
        ...
        _get('/api/v1/app/cards/plan/all', {
          ...
          if (res.state === 1) {
            ...
            if (res.data.delay_orders.length) {
      ...
      toSpeedup80() {
        this.$router.push({path: '/weixin/speedup/plan_80'});
      },
      toSpeedup500() {
        this.$router.push({path: '/weixin/speedup/plan_500'});
      },
      // toConnection(params){
      //     if(params.type!=0){
      //         return
